<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">EDIT CATEGORIES</div>
		...
		<div class="col-xl-11 mx-auto">
			<div class="card">
				...
				<h6 class="mb-0 text-uppercase">Edit Categories</h6>
					<div class="p-4 border rounded mt-4">
						<form action="<?php echo $base_url ?>/categories/update" method="post" class="row g-3 needs-validation" novalidate="">
            ...
            <input type="hidden" name="id" class="form-control" value="<?php echo $categories->id?>">
							...
							<div class="col-md-6">
								...
								<input type="text" name="name" class="form-control" required="required" placeholder="Categories Name" value="<?php echo $categories->name?>">

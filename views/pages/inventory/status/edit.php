<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">EDIT STATUS</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Edit Status</h6>
					<div class="p-4 border rounded mt-4">
						<form action="<?php echo $base_url ?>/status/update" method="post" class="row g-3 needs-validation" novalidate="">
            ...
            <input type="hidden" name="id" class="form-control" value="<?php echo $status->id?>">
							...
							<div class="col-md-6">
								...
								<input type="text" name="name" class="form-control" required="required" placeholder="Status Name" value="<?php echo $status->name?>">

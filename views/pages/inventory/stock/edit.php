<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">EDIT STOCK</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Edit Stock</h6>
					<div class="p-4 border rounded mt-4">

						<form action="<?php echo $base_url ?>/stock/update" method="post" class="row g-4 needs-validation" novalidate="">
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<input type="number" name="qty" class="form-control" required="required" placeholder="Price" value="<?php echo $stock->qty ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>

							<div class="col-md-12">
								<label for="validationCustom01" class="form-label">Remark <strong style="color: red;">*</strong></label>
								<textarea class="form-control" id="validationTextarea" placeholder="Remark" required="required" name="remark" id=""><?php echo $stock->remark ?></textarea>
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-12">
								<button class="btn btn-primary" name="btnUpdate" type="submit"><i class="bi bi-save"></i> Save Stock</button>
							</div>
						</form>

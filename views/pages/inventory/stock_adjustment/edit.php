<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">EDIT STOCK_ADJUSTMENT</div>
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Edit Stock_adjustment</li>
				</ol>
			</nav>
		</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Edit Stock_adjustment</h6>
					<div class="p-4 border rounded mt-4">

						<form action="<?php echo $base_url ?>/stock_adjustment/update" method="post" class="row g-4 needs-validation" novalidate="">

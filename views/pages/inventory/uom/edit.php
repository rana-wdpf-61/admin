<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">EDIT UOM</div>
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Edit Uom</li>
				</ol>
			</nav>
		</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Edit Uom</h6>
					<div class="p-4 border rounded mt-4">
						<form action="<?php echo $base_url ?>/uom/update" method="post" class="row g-3 needs-validation" novalidate="">
            ...
            <input type="hidden" name="id" class="form-control" value="<?php echo $uom->id?>">
							...
							<div class="col-md-6">
								...
								<input type="text" name="name" class="form-control" required="required" placeholder="Uom Name" value="<?php echo $uom->name?>">

<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">CREATE WAREHOUSE</div>
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Add a new Warehouse</li>
				</ol>
			</nav>
		</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Add a new Warehouse</h6>
					<div class="p-4 border rounded mt-4">

						<!-- Start Form Validation -->

						<form action="<?php echo $base_url ?>/warehouse/save" method="post" class="row g-4 needs-validation" novalidate="">
							...
							<div class="col-md-12">
								<label for="validationCustom01" class="form-label">Location Number <strong style="color: red;">*</strong></label>
								<input type="text" name="location" class="form-control" required="" placeholder="Phone Number">
								<div class="valid-feedback">Looks good!</div>
							</div>
						
							<div class="col-md-12">
								<label for="validationCustom01" class="form-label">Warehouse Address <strong style="color: red;">*</strong></label>
								 <textarea class="form-control" id="validationTextarea" placeholder="Warehouse Address" required="" name="address" id=""></textarea> 
								<div class="valid-feedback">Looks good!</div>
							</div>

<main class="container">
  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">WAREHOUSE DETAILS</div>
    ...
    <div class="ms-auto">
      <div class="btn-group">
        ...
        <a class="btn btn-primary" href="<?php echo $base_url ?>/warehouse/create"> Add Warehouse<i class="bi bi-plus-circle"></i></a>

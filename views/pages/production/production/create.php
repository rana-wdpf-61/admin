            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="container-para">
                                <div class="row col-md-md-12">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" id="product_qty" name="name" class="form-control" required="required" placeholder="Quantity">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="inputPassword6" class="col-form-label">Stating Date :</label>
                                        <input type="date" id="start_date" name="name" class="form-control" required="required">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="inputPassword6" class="col-form-label">Ending Date :</label>
                                        <input type="date" id="end_date" name="name" class="form-control" required="required">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end "><button class="btn btn-success process">Send Raw-Material</button></div>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_add").on("click", function() {
            ...
            let subtotal = price * item_qty;

           // console.log(item_qty, uom_id, uom_name, product_name, product_id,price,subtotal);

            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    ...
                    <h4>Create a Purchases</h4>
                        ...
                        <div class="invoice-body">
                            ...
                            <div class="row" style="margin-bottom: 50px; margin-left:20px">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="purchases_date" name="name" class="form-control" value="<?php echo date("d-m-Y") ?>">
                                </div>
                                <div class="col-md-6" >
                                    <label for="" class="form-label">Delivery Date :</label>
                                    <input type="text" id="Purchases_deliveryDate" name="name" class="form-control" value="<?php echo date("d-m-Y", strtotime("+3 days")); ?>">
                                </div>
                            </div>
                            ...
                            <table class="items-table ">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><input type="number" class="form-control" id="discount" name="discount"></th>
                                        <th>0.00</th>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end "><button class="btn btn-success process">Create Purchases</button></div>

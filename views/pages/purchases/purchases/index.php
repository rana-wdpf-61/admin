  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ps-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active" aria-current="page">Purchases Details</li>
        </ol>
      </nav>
    </div>
    ...
    <div class="ms-auto">
      <div class="btn-group">
        ...
        <a class="btn btn-primary" href="<?php echo $base_url ?>/purchases/create"> Add Purchases<i class="bi bi-plus-circle"></i></a>
    ...
    <div class="card-body">
      ...
      <nav aria-label="Page navigation example">
        ...
        <div class="p-0 table-responsive table-custom my-3 m-0">
          <table class="table table-bordered table-striped table-hover align-middle">
            ...
            <tbody>
              ...
              $limit = $db->query("select * from all_purchases_view limit $start, $per_page");
        ...
        <ul class="pagination justify-content-end m-3">
          <li class="page-item"><a class="page-link" href="<?php echo $base_url ?>/purchases/index?page_no=1">First</a></li>

          <?php

          if (isset($_GET["page_no"]) && $_GET["page_no"] > 1) {
            $page_no = $_GET["page_no"] - 1;
            echo "<li class='page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=$page_no'>Previous</a></li>";
          } else {
          ...
          <?php
          if (!isset($_GET["page_no"])) {
            echo " <li class='active page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=1'>1</a></li>";
            $counter = 2;
          } else {
            $counter = 1;
          }
          ...
          for ($i = $counter; $i <= $pages; $i++) {
            if (isset($_GET["page_no"])  &&  $i == ($_GET["page_no"])) {
              echo " <li class='active page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=$i'>$i</a></li>";
            } else {
              echo " <li class='page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=$i'>$i</a></li>";
            }
          }
          ?>
          ...
          if (isset($_GET["page_no"]) && $_GET["page_no"] >= $pages) {
            ...
            $page_no = $_GET["page_no"] + 1;
            echo "<li class='page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=$page_no'>Next</a></li>";
          } else {
            echo "<li class='page-item'><a class='page-link' href='{$base_url}/purchases/index?page_no=2'>Next</a></li>";
          }
          ?>
          <!-- <li class="page-item"><a class="page-link" href="#">Next</a></li> -->
          <li class="page-item"><a class="page-link" href="<?php echo $base_url ?>/purchases/index?page_no=<?php echo $pages ?>">Last</a></li>
        </ul>
      </nav>
    </div>
</main>

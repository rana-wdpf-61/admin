...
<body>
    <main class="container">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">CREATE SALES</div>
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create a New Sales</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body">
                    <h4>Create a Sales</h4>
                        <!-- <h5 class="mb-0">Create a New Sales Invoice</h5>
                        ...
                        <div class="invoice-header">
                            ...
                            <!-- <div class="invoice-detailss">
                                <div class="row">
                                    <p> <strong> </strong><span id="Date"><?php // echo Order::get_last_id() + 1 + 1000 
                                                                                ?>
                                        </span><br><strong>Date:</strong> <span id="Order_date_id"><?php // echo date("d-m-Y") ?></span> <br>
                                        <strong>Delivery Date :</strong> <span><input type="text" id="deliveryDate_id" value=<?php // echo date("d-m-Y"); ?>></span>
                                    </p>
                                </div>
                            </div> -->
                        </div>
                        ...
                        <div class="invoice-body">
                            ...
                            <div class="container-para">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <h5>Customer Info :</h5>
                                        <span><?php echo Customar::html_select("customer_id") ?></span> <br>
                                        <strong>Phone :</strong> <span id="phone" style="font-size: 16px;"></span> <br>
                                        <strong>Email :</strong> <span id="email" style="font-size: 16px;"></span> <br>
                                        <strong>Address :</strong> <span id="address" style="font-size: 16px;"></span> <br> <br>
                                    </div>
                                    <div class="col-md-3">
                                    <h5>Shipping Address :</h5> <br>
                                 <strong>Address : </strong><span id="ship_to"></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="" class="form-label">Sales Date :</label>
                                        <input type="date"  id="Order_date_id" name="name" class="form-control"  value="<?php // echo date("d-m-Y") ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="" class="form-label">Delivery Date :</label>
                                        <input type="date" id="deliveryDate_id" name="name" class="form-control" value="<?php // echo date("d-m-Y", strtotime("+3 days")); ?>"> 
                                    </div>
                                </div>

                                <!-- <div class="child-container--two">
                                        <h5>Warehouse Details :</h5>
                                        <span><?php // echo Warehouse::html_select("warehouse") 
                                                ?></span>
                                        <span id="phone" style="font-size: 16px;"></span> <br>
                                        <span id="location" style="font-size: 16px;"></span> <br>
                                        <span id="address" style="font-size: 16px;"></span> <br> <br>
                                </div>  -->
                            ...
                            <table class="items-table ">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><input type="number" class="form-control Order_discount" id="discount" name="discount" placeholder="Discount"></th>
                                        <th>0.00</th>
...
<script>
    $(document).ready(function() {
        ...
        $("#customer_id").on("change", function() {
            let customar_id = $(this).val();


            $.ajax({
                url: "<?php echo $base_url ?>/api/customar/find",
                type: "get",
                data: {
                    id: customar_id
                },
                success: function(res) {
                    ...
                    //console.log(res);
                    $("#phone").text(cus.customar.phone)
                    $("#email").text(cus.customar.email)
                    $("#address").text(cus.customar.address)
                    $("#ship_to").text(cus.customar.address)
        ...
        //             $("#phone").text(ware.warehouse.phone)
        //             $("#location").text(ware.warehouse.location)
        //             $("#address").text(ware.warehouse.address)
        ...
        $("#btn_add").on("click", function() {
            ...
            let subtotaltwo = (unit_price * item_qty) - discount;
        ...
        $(".process").on("click", function() {
            let customar_id = $("#customer_id").val();
            let order_date = $("#Order_date_id").val();
            let delivery_date = $("#deliveryDate_id").val();
            let discount = "";
            let vat = 0;
            let shipping_address = $("#ship_to").text();
            let remark = "";
            let order_total = $("#net_total").text();
            let products = cart.getCart();

            console.log(products);
             console.log(customar_id,order_date,delivery_date,order_total,discount,shipping_address);

            $.ajax({
                url: '<?php echo $base_url ?>/api/orderprocess/save',
                type: 'POST',
                data: {

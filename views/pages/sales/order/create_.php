<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">CREATE ORDER</div>
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Add a new Order</li>
				</ol>
			</nav>
		</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Add a new Order</h6>
					<div class="p-4 border rounded mt-4">

						<form action="<?php echo $base_url ?>/order/save" method="post" class="row g-4 needs-validation" novalidate="" enctype="multipart/form-data">
							...
							<div class="col-md-4">
								...
								<select name="customars_id" id="" class="form-select">
									<option value="">Select Suppliers_id</option>
									<?php  
							...
							<div class="col-md-4">
								...
								<input type="date" name="order_date" class="form-control" required="required" placeholder="">
								<div class="valid-feedback">Looks good!</div>
							</div>

							<div class="col-md-4">
								<label for="validationCustom01" class="form-label">Delivery_date<strong style="color: red;">*</strong></label>
								<input type="date" name="delivery_date" class="form-control" required="required" placeholder="">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-12">
								<button class="btn btn-primary" name="btnSubmit" type="submit"><i class="bi bi-save"></i> Save Order</button>
							</div>
						</form>
					</div>
				</div>

        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add a new Order Invoice</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card-body" id="section-to-print">
                    <div class="invoice-header">
                        ...
                        <div class="invoice-details">
                            ...
                            <p><strong>Invoice #: </strong>INVC-ID-<?php echo 1000 + $order->id  ?><br><strong>Date :</strong> <?php echo  date("F d, Y", strtotime($order->created_at)) ?><br><strong>Delivery Date :</strong> <input type="text" id="deliveryDate" value=<?php echo date("d-m-Y"); ?>></p>
                        </div>
                    </div>
                    ...
                    <div class="invoice-body">
                        <table class="billing-info">
                            <tr>
                                <td><strong style="font-size: 18px; text-decoration:underline">Customer's Information:</strong> <br>
                                <strong> Name : </strong><?php echo Customar::find($order->customar_id)->name ?> <br>
                                <strong> Phone :</strong> <?php echo Customar::find($order->customar_id)->phone ?> <br>
                                <strong> Email : </strong> <?php echo Customar::find($order->customar_id)->email ?> <br>
                                <strong>Address :</strong> <?php echo Customar::find($order->customar_id)->address ?> <br>

                                <td><strong style="font-size: 18px; text-decoration:underline">Shipping :</strong> <br> 
                                <strong>Address :</strong> <?php echo  Customar::find($order->customar_id)->address ?><br></td>
                            </tr>
                        </table>
                        ...
                        <table class="items-table">
                            ...
                            <tbody>
                                <?php
                                // echo $purchases->id;
                                $order_details = Order_details::find_all($order->id);

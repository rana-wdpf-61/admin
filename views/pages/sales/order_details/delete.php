<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">Delete ORDER-DETAILS</div>
		...
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Delete Order_details</li>
				</ol>
			</nav>
		</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
					<h6 class="mb-0 text-uppercase">Delete Order_details</h6>
					<div class="p-4 border rounded mt-4">

						<form action="<?php echo $base_url ?>/order_details/delete_confirm" method="post" class="row g-4 needs-validation" novalidate="" enctype="multipart/form-data">
						...
						<input type="hidden" name="id" class="form-label" value="<?php echo $order_details->id?>">
							...
							<div class="col-md-4">
								...
								<select disabled name="core_products_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<select disabled name="core_order_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="price" class="form-control" required="required" placeholder="Price" value="<?php echo $order_details->price?>">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="qty" class="form-control" required="required" placeholder="Discount" value="<?php echo $order_details->qty?>">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-md-4">
								...
								<select disabled name="core_uom_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="vat" class="form-control" required="required" placeholder="Vat" value="<?php echo $order_details->vat?>">
								<div class="valid-feedback">Looks good!</div>
							</div>

							<div class="col-12">
								<button class="btn btn-primary" name="btnUpdate" type="submit"><i class='bi bi-trash-fill'></i> Delete</button>
							</div>
						</form>
					</div>
				</div>

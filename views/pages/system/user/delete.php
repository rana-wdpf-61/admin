<main class="container">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">Delte ORDER</div>
	...
	<div class="row">
		<div class="col-xl-11 mx-auto">
			<div class="card">
				<div class="card-body">
				<h6 class="mb-0 text-uppercase">Delete Order</h6>
					<div class="p-4 border rounded mt-4">

						<form action="<?php echo $base_url ?>/order/delete_confirm" method="post" class="row g-4 needs-validation" novalidate="" enctype="multipart/form-data">
						...
						<input type="hidden" class="form-label" name="id" value="<?php echo $order->id ?>">
							...
							<div class="col-md-4">
								...
								<select disabled name="customars_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="order_total" class="form-control" required="required" placeholder="Order_total" value="<?php echo $order->order_total ?>">
							...
							<div class="col-md-4">
								...
								<select disabled name="uom_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="discount" class="form-control" required="required" placeholder="Discount" value="<?php echo $order->discount ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-md-4">
								...
								<input disabled type="number" name="vat" class="form-control" required="required" placeholder="Vat" value="<?php echo $order->vat ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>

							<div class="col-md-4">
								<label for="validationCustom01" class="form-label">Paid_amount<strong style="color: red;">*</strong></label>
								<input disabled type="number" name="paid_amount" class="form-control" required="required" placeholder="Paid_amount" value="<?php echo $order->paid_amount ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-md-4">
								...
								<select disabled name="status_id" id="" class="form-select">
							...
							<div class="col-md-4">
								...
								<input disabled type="date" name="order_date" class="form-control" required="required" placeholder="" value="<?php echo $order->order_date ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>

							<div class="col-md-4">
								<label for="validationCustom01" class="form-label">Delivery_date<strong style="color: red;">*</strong></label>
								<input disabled type="date" name="delivery_date" class="form-control" required="required" placeholder="" value="<?php echo $order->delivery_date ?>">
								<div class="valid-feedback">Looks good!</div>
							</div>
							...
							<div class="col-md-12">
								...
								<textarea disabled class="form-control" id="validationTextarea" placeholder="Shipping_address" required="required" name="shipping_address" id=""><?php echo $order->shipping_address?></textarea> 
